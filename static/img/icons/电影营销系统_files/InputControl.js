    ...
    function (require) {
        ...
        function checkValidity(control) {
            ...
            for (var i = 0, len = rules.length; i < len; i++) {
                ...
                validity.addState( 
                    rule.getName(), 
                    rule.check(lib.trim(control.getValue()), control)
                );
            }
        ...
        InputControl.prototype = {
            ...
            getValidityLabel: function (dontCreate) {
                ...
                if (!label && !dontCreate) {
                    ...
                    if ($(this.main).parents('.control-group').length) {
                        label.appendTo($(this.main).parents('.control-group')[0]);
                    }
                    else if (this.main.nextSibling) {
