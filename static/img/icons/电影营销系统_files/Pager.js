...
define(
    function (require) {
        ...
        Pager.prototype = {
             ...
             * @protected
             */
            setProperties: function (properties, silent) {
                ...
                // 设置silent状态，下面setProperties会触发select的change事件，
                // initStructure方法中监听了该事件，changePageSize方法触发pager的pagesizechange，造成多余的列表请求第一页
                this.silent = silent;
                var changes = 
                ...
                if (changes.hasOwnProperty('page') && !silent) {
                    // 触发页码变更事件
