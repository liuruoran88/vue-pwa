define(
    function (require) {
        ...
        UIView.prototype.bindEvents = function () {
            ...
            // enter 自动保存,这里只针对popdialog绑定的enter；
            // 判断条件，子action且enter不是text文本框换行，且是submit按钮的关联该事件；
            // var isChild = this.model.store.isChildAction;
            // if (isChild) {
            //     var that = this;
            ...
            //         if (e.keyCode === 13 && $target !== 'text' && that.get('submitBtn')) {
            //             that.get('submitBtn').fire('click');
            //         }
            //     });
            // }
        };
        ...
        /**
         * 销毁当前视图
         * 注意要销毁绑定在document、body、windows上的事件
         * @override
         * @protected
         */
